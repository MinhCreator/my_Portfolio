      ...
      <div className="flex flex-col gap-3">
        ...
        <FramerWrapper y={0} x={200}>
          <p className="font-poppins text-xl w-full text-primary max-sm:text-lg">
            ...
            CSS3, JavaScript, GDscript, React and Python, including responsive
            design principles. Moveover, my game project based on Godot Engine .
            I specialize in building web applications and sites using
        ...
        <FramerWrapper className="block" y={100} delay={0.32}>
          ...
          <div className="w-full h-fit flex-row flex justify-between gap-x-10 gap-y-5 items-center flex-wrap">
